...
<aside id="mainSidebar" class="fixed inset-y-0 left-0 transform -translate-x-full md:translate-x-0 w-72 h-screen max-h-screen bg-red-800 text-white flex flex-col shadow-2xl transition-transform duration-300 ease-in-out z-50 overflow-y-auto">
    ...
    <nav class="flex-1 p-6 space-y-2">
        ...
        <a href="tambah-catatan" class="flex items-center space-x-3 p-4 transition-all rounded-xl <?= ($current_page == 'tambah-catatan') ? 'bg-orange-600 border-l-4 border-white font-semibold shadow-lg shadow-orange-900/20' : 'hover:bg-white/10 opacity-70 hover:opacity-100' ?>">
            ...
            <span class="text-sm">Tambah Laporan</span>
        </a>
        <?php endif; ?>
...
<div class="sidebar-spacer hidden md:block w-72 flex-shrink-0" aria-hidden="true"></div>
