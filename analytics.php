...
<body class="bg-gray-50 flex flex-col md:flex-row min-h-screen">
    ...
    <main class="flex-1 p-6 md:p-12 overflow-y-auto">
        ...
        <div class="bg-white rounded-[28px] border border-gray-100 shadow-sm overflow-hidden mb-12">
            <div class="p-6 border-b border-gray-50 flex flex-col sm:flex-row sm:justify-between sm:items-center gap-4">
                <h4 class="text-xs font-black uppercase tracking-widest text-gray-500">Tabel Data Agen</h4>
                <div class="export-actions">
                    <a href="export-agen<?= ($filterPeriode ? '?mulai='.urlencode($tgl_mulai).'&selesai='.urlencode($tgl_selesai) : '') ?>" class="export-button export-button-excel"><i class="fas fa-file-excel"></i> Export Excel</a>
                </div>
            </div>
        ...
        <div class="bg-white rounded-[28px] border border-gray-100 shadow-sm p-8">
            <div class="flex flex-col sm:flex-row sm:justify-between sm:items-start gap-4">
                <div>
                    <h4 class="text-xs font-black uppercase tracking-widest text-gray-500 mb-2">Export Laporan Periode</h4>
                    <p class="text-sm text-gray-500">Unduh data laporan masyarakat dalam rentang tanggal yang dipilih (Excel .xlsx).</p>
                </div>
                <div class="export-actions">
                ...
                <a href="cetak-laporan?tgl_mulai=<?= urlencode($tgl_mulai) ?>&tgl_selesai=<?= urlencode($tgl_selesai) ?>" target="_blank" rel="noopener"
