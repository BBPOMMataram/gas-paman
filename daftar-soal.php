        ...
        <div class="max-w-5xl mx-auto">
            ...
            <div class="flex flex-col sm:flex-row justify-between items-start sm:items-center gap-4 mb-10">
                ...
                <div class="flex flex-wrap items-center gap-3">
                    <a href="import-soal" class="inline-flex items-center gap-2 bg-gradient-to-r from-orange-600 to-red-600 hover:from-orange-700 hover:to-red-700 text-white text-xs font-black uppercase tracking-widest px-6 py-4 rounded-2xl transition-all shadow-lg shadow-orange-600/30">
                        <i class="fas fa-robot"></i> Import Otomatis
                    </a>
            ...
            <?php if ($swal_type): ?>
            <div class="rounded-2xl border px-5 py-4 font-bold text-sm mb-8 flex items-start gap-3 <?= $swal_type === 'error' ? 'bg-red-50 border-red-200 text-red-800' : 'bg-green-50 border-green-200 text-green-700' ?>">
                <i class="fas fa-<?= $swal_type === 'error' ? 'exclamation-circle' : 'check-circle' ?> mt-0.5"></i>
